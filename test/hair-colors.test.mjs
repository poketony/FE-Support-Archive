...
test("Fates children use their fixed parent's hair color", () => {
  ...
  assert.deepEqual(hairColorForCharacter("fates", "ソレイユ"), [0x99, 0x91, 0x91]);
...
test("Robin and Corrin use their official default hair colors", () => {
  ...
  assert.deepEqual(hairColorForCharacter("awakening", "マーク女"), [0xF6, 0xF4, 0xEF]);
